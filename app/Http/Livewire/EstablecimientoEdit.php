...
class EstablecimientoEdit extends Component
{
    ...
    public function mount(Establecimiento $establecimiento)
    {
        ...
        $this->departamento_id = $establecimiento->departamento_id;
        
        $this->distrito = Distrito::where('departamento_id', $this->departamento_id)->get();
        $this->distrito_id = $establecimiento->distrito_id;

        $this->ciudad = Ciudad::where('distrito_id', $this->distrito_id)->get();
        $this->ciudad_id = $establecimiento->ciudad_id;
    }
   ...
   public function updatedDepartamentoId($value)
    ...
    {
        return view('livewire.establecimiento-edit');
    }
}
