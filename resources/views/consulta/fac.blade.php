    ...
    <div  class="col-lg-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                ...
                <form action="{{route('consulta.factura')}}" method="get">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <div class="form-row mb-2">
                                <div class="form-group col-md-3">
                                    <label for="">Fecha Desde</label>
                                    <input type="date" name="fecha_desde" id="fecha_desde" class="form-control" value="{{$fecha_desde}}" required>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="">Fecha Hasta</label>
                                    <input type="date" name="fecha_hasta" id="fecha_hasta" value="{{$fecha_hasta}}" class="form-control" required>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                {{$item->factura_sucursal}}-{{$item->factura_general}}-{{$item->factura_numero}}
                                            </td>
                                            <td>
                                                {{$item->concepto}}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($item->sifen?->sifen_estado)
                                            ...
                                            <td class="text-center">
                                                {{-- <ul class="table-controls">
                                                    ...
                                                    <li>
                                                        @if ($item->sifen_estado == 'RECHAZADO')
                                                            <a href="{{route('factura.edit', $item->factura_id)}}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                                    stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                                                </svg>
                                                            </a>
                                                        @endif
                                                    </li>
                                                    <li>
                                                        @if ($item->sifen_estado == 'APROBADO')
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Anular">
                                                                ...
                                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger">
